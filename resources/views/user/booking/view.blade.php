                ...
                <div class="tab-pane fade" id="tab4" role="tabpanel" aria-labelledby="pills-other-info-tab">
                    <div class="eb-booking-info-tab">
                        ...
                        <div class="mr-auto p-2 bd-highlight">
                            <button type="button" class="btn btn-secondary eb-form-submit eb-delete-btn ">Kembali</button>
                        </div>
                        <div class="p-2 bd-highlight">
                            <button type="submit" class="btn btn-danger" >Batalkan Tempahan</button>
                        </div>
                        <div class="p-2 bd-highlight">
                            <button type="submit" class="btn btn-primary" >Kemaskini Tempahan</button>
                        </div>
                        </div>
