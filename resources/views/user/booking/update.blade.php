...
@section('title', 'Tempahan telah Dikesmaskini')
        ...
        <div class="text-center border-0 shadow-sm card p-4">
            <div class="card-body">
                <div class="mb-3">
                    ...
                    <h3 class="card-title">Tempahan berjaya dikemas kini</h3>
                    <p class="card-text">Permohonan kemaskini anda sedang di dalam proses. <br>
