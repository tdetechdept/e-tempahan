...
@section('content')
    <!-- <h1>Welcome to E-Tempahan</h1>
                <p>This is the home page content.</p> -->
    <div class="mb-4 row">
        <div class="mb-3 col-lg-7">
            <div class="p-4 bg-gradient-dark rounded-3 h-100 align-content-center ">
                <h1 class="mb-3 text-white fs-1">Welcome to the eReservation system</h1>
                <p class="text-white fs-5">Manage and monitor all bookings easily and efficiently</p>
            </div>
        </div>
        <div class="flex-wrap gap-3 mb-3 col-lg-5 d-flex">
            <div class="p-4 text-center bg-gradient-dark rounded-3 col-lg-6 eb-inner-box flex-grow-1">
                ...
                <h4 class="text-white fs-6">Total Rooms</h4>
            ...
            <div class="p-4 text-center bg-gradient-dark rounded-3 col-lg-6 eb-inner-box flex-grow-1">
                ...
                <h4 class="text-white fs-6">Total Users</h4>
            ...
            <div class="gap-5 px-3 py-5 bg-gradient-dark rounded-3 w-100 d-flex justify-content-center align-items-center">
                ...
                <h4 class="mb-0 text-white fs-6">Total Bookings</h4>
    ...
    <div class="p-1 py-2 mb-3 card rounded-4">
        <div class="bg-white card-header border-bottom-0 rounded-top-4">
            <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center">
                <h5 class="mb-2 card-title mb-md-0 fw-semibold">Room List</h5>
        ...
        <div class="card-body">
            ...
            <div class="mb-3 row align-items-center">
                <div class="col-md-6">
                    <div class="gap-2 d-flex flex-column flex-sm-row align-items-sm-center">
                        <span class="mr-3 font-medium  small eb-custom-color">List</span>
            ...
            <div id="roomTableWrapper" class="table-responsive eb-table-wrapper">
                <table id="roomTable" class="table">
                    <thead>
                        <tr>
                            <th scope="col" class="text-muted fw-normal small">No.</th>
                            <th scope="col" class="text-muted fw-normal small">Room Profile</th>
                            <th scope="col" class="text-muted fw-normal small">Level</th>
                            <th scope="col" class="text-muted fw-normal small">Capacity</th>
                            <th scope="col" class="text-muted fw-normal small">Facilities</th>
                            <th scope="col" class="text-muted fw-normal small">Status</th>
                            <th scope="col" class="text-muted fw-normal small">Action</th>
                        </tr>
                    </thead>
                    <tbody>
                        @foreach ($rooms as $index => $room)
                            <tr>
                                ...
                                <td>
                                    @if ($room->status == 1)
                                        <span
                                            class="block py-2 text-center badge text-bg-success w-100 rounded-4">ACTIVE</span>
                                    @else
            ...
            <div id="userTableWrapper" class="table-responsive eb-table-wrapper" style="display: none;">
                <table id="userTable" class="table">
                    <thead>
                        <tr>
                            <th scope="col" class="text-muted fw-normal small">No.</th>
                            <th scope="col" class="text-muted fw-normal small">Name</th>
                            <th scope="col" class="text-muted fw-normal small">Email</th>
                            <th scope="col" class="text-muted fw-normal small">Date/Time</th>
                            <th scope="col" class="text-muted fw-normal small">Apply Date</th>
                            <th scope="col" class="text-muted fw-normal small">Status</th>
                            <th scope="col" class="text-muted fw-normal small">Action</th>
                        </tr>
                    </thead>
                ...
                <table id="rezervationTable" class="table">
                    <thead>
                        <tr>
                            <th scope="col" class="text-muted fw-normal small">No.</th>
                            <th scope="col" class="text-muted fw-normal small">Name</th>
                            <th scope="col" class="text-muted fw-normal small">Room Name</th>
                            <th scope="col" class="text-muted fw-normal small">Date/Time</th>
                            <th scope="col" class="text-muted fw-normal small">ApplyDate</th>
                            <th scope="col" class="text-muted fw-normal small">Status</th>
                            <th scope="col" class="text-muted fw-normal small">Action</th>
                        </tr>
                    </thead>
