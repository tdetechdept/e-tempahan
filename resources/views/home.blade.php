...
@section('content')
    <div class="mb-4 row">
        <div class="mb-3 col-lg-7">
            <div class="p-4 bg-gradient-dark rounded-3 h-100 d-flex flex-column justify-content-center">
        ...
        <div class="col-lg-5">
            <div class="row g-3">
                <div class="col-md-6">
                    <div class="p-4 text-center bg-gradient-dark rounded-3 h-100 d-flex flex-column justify-content-center">
                        <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg" class="mb-3 mx-auto">
                            <path
                        ...
                        <h4 class="text-white fs-6 mb-2">Total Bilik</h4>
                        <span class="text-white fs-4 fw-bold">{{ $totalRooms }}</span>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="p-4 text-center bg-gradient-dark rounded-3 h-100 d-flex flex-column justify-content-center">
                        <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg" class="mb-3 mx-auto">
                            <path
                        ...
                        <h4 class="text-white fs-6 mb-2">Total Pengguna</h4>
                        <span class="text-white fs-4 fw-bold">{{ $totalUsers }}</span>
                    </div>
                </div>
                <div class="col-12">
                    <div class="p-4 bg-gradient-dark rounded-3 d-flex justify-content-center align-items-center">
                        <svg width="41" height="40" viewBox="0 0 41 40" fill="none" xmlns="http://www.w3.org/2000/svg" class="me-3">
                        ...
                        <div class="text-center">
                            <h4 class="mb-2 text-white fs-6">Total Tempahan</h4>
                            <span class="text-white fs-4 fw-bold">{{ $totalBookings }}</span>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <tbody>
                        @foreach ($rooms as $index => $room)
                            <tr>
                                ...
                                <td>{{ $room->level ?? 'N/A' }}</td>
                                <td>{{ $room->room_capacity ?? 'N/A' }} Orang</td>
                                <td>{{ is_array($room->facilities) ? implode(', ', $room->facilities) : ($room->facilities ?? 'N/A') }}
                                </td>
                                <td>
                                    @if ($room->status == 1)
