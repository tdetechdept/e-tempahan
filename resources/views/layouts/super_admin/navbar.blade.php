                        ...
                        <a class="dropdown-item d-flex align-items-center" href="{{route('user.booking.show', [$notification->id, 'read' => 1])}}">
                            ...
                            <div>
                                @if ($notification->status == 1)
                                    <span class="font-weight-bold text-primary">[BAHARU]</span>
                                @elseif ($notification->status == 2)
                                    <span class="font-weight-bold text-primary">[PERLU SEMAKAN]</span>
                                @elseif ($notification->status == 3 || $notification->status == 4)
