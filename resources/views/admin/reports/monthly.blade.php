...
@section('title', 'Laporan Tempahan Bulanan')
    ...
    @section('breadcrumb')
        <div class="breadcrumb-section">
            ...
            <div class="breadcrumb-nav">
                ...
                <span class="mx-2">/</span>
                <a href="#" class="text-decoration-none breadcrumb-active">Laporan Tempahan Bulanan</a>
            </div>
        </div>
    @endsection
        ...
        {{-- <div class="breadcrumb-section mb-4">
            ...
            <div class="breadcrumb-nav">
                ...
                <span class="mx-2">/</span>
                <span class="breadcrumb-active">Laporan Tempahan Bulanan</span>
            </div>
        </div> --}}
        ...
        @isset($bookings)
            <div class="card shadow-sm border-0 p-4">
                <div class="d-flex justify-content-between align-items-center mb-3">
                    <h4 class="mb-0 font-weight-bold">Laporan Tempahan Bulanan</h4>
                </div>
...
<script>
    function exportToPDF() {
        ...
        doc.text("Laporan Tempahan Bulanan", 14, 15);
        doc.autoTable({
            html: '#booking-table',
            startY: 25,
            theme: 'striped',
    ...
    function exportToWord() {
        ...
        link.download = "Laporan_Tempahan_Bulanan.doc";
