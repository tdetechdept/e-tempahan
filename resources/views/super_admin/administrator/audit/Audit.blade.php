...
@section('content')
    <div class="pengurusan_pengguna_page ">
        ...
        <div class="audit_table_container">
            ...
            <div class="input_filds_date_name">
                <div class="form-group">
                    <label for="datepicker">Tarikh</label>
                    <input type="date" class="form-control" id="datepicker" placeholder="Pilith Tarikh">
                </div>
                <div class="form-group">
                    <label for="username">Name Prngguna</label>
                ...
                <table class="custom-table">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>Bahagian Akaun(ba)</td>
                            <td>Lorem, ipsum.</td>
                            <td><span class="badge AKTIF">AKTIF</span></td>
                            <td>192.168.0.1</td>
                            <td>
                                <a href="/audit/record-user-activity" class="btn-view"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
